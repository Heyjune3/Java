...
public class LocalDateTimeExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("10분 전 : " + targetTime);
		
		// 30초 후
		targetTime = present.plusSeconds(30);
		System.out.println("30초 후 : " + targetTime);
		...
		DateTimeFormatter pattern
			= DateTimeFormatter.ofPattern("yyyy년 MM월 dd일 E요일 a KK시 mm분 ss초");
